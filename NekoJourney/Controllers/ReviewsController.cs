...
namespace NekoJourney.Controllers
{
    public class ReviewsController : Controller
    {
        private readonly NekoContext _context;

        public ReviewsController(NekoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdReview,Nama,Review1")] Review review)
        {
